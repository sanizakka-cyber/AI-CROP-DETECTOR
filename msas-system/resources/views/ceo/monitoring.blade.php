...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:28px;">
    ...
    $healthCards = [
        ...
        ['label'=>'Payments', 'id'=>'pay', 'ok'=>($paySuccessRate === null || $paySuccessRate >= 80), 'detail'=>($paySuccessRate === null ? 'No payments yet today' : $paySuccessRate.'% success rate today'), 'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>'],
    ];
    @endphp
