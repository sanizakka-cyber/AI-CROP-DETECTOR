    ...
    <div class="space-y-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            <div class="bg-white border border-slate-200 p-6 rounded-2xl hover:border-[#1FA84A] hover:shadow-md transition group">
                ...
                <h3 class="font-bold text-slate-800 text-base mb-1">Crop Advisory</h3>
                <p class="text-xs text-slate-500 mb-4">Agronomist consultations, crop case types, and intervention outcomes.</p>
            ...
            <div class="bg-white border border-slate-200 p-6 rounded-2xl hover:border-[#1FA84A] hover:shadow-md transition group">
                ...
                <p class="text-xs text-slate-500 mb-4">All registered users, roles, activity status, and sign-up trends.</p>
                <a href="{{ url('/ceo/reports/users') }}" class="block w-full py-2 bg-[#0F6B3E] text-white rounded-xl text-sm font-semibold text-center hover:bg-[#047857] transition">
                    &#9654; Generate
                </a>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <p class="text-sm text-slate-400 text-center py-6">Report generation history will appear here once the export feature is enabled. Use the cards above to generate and view any report now.</p>
        </div>
