            ...
            <div class="grid md:grid-cols-4 gap-12 mb-14">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <a href="#" aria-label="Facebook" class="w-10 h-10 rounded-full bg-cardlight flex items-center justify-center text-gray-400 hover:bg-[#3b82f6] hover:text-white transition">
                        ...
                        <a href="#" aria-label="Instagram" class="w-10 h-10 rounded-full bg-cardlight flex items-center justify-center text-gray-400 hover:text-white transition hover:bg-[#E1306C]">
                        ...
                        <a href="#" aria-label="LinkedIn" class="w-10 h-10 rounded-full bg-cardlight flex items-center justify-center text-gray-400 hover:bg-[#0077b5] hover:text-white transition">
