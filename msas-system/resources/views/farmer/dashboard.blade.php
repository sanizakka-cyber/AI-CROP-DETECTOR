...
<x-slot name="header">
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;">
        <div>
            ...
            <p style="font-size:13px;color:#64748b;margin:4px 0 0;">Here's what's happening on your farm today</p>
        </div>
...
<div style="background:linear-gradient(135deg,#0B2447,#0F6B3E);border-radius:16px;padding:20px 24px;margin-bottom:24px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;">
    <div style="display:flex;align-items:center;gap:14px;">
        ...
        <div>
            <div style="color:rgba(255,255,255,0.7);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;">No Active Subscription</div>
            <div style="color:#fff;font-size:16px;font-weight:800;margin-top:2px;">Start your 14-day free trial today</div>
            <div style="color:rgba(255,255,255,0.55);font-size:12px;margin-top:2px;">Unlock livestock management, reports, and AI-powered tools</div>
        </div>
    </div>
...
<div style="background:linear-gradient(135deg,#0B2447,#0F6B3E);border-radius:16px;padding:18px 24px;margin-bottom:24px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;position:relative;overflow:hidden;">
    ...
    <div style="display:flex;gap:20px;position:relative;">
        <div style="text-align:center;">
            ...
            <div style="color:rgba(255,255,255,0.5);font-size:10px;font-weight:600;text-transform:uppercase;">Days Left</div>
        </div>
        <div style="text-align:center;">
            <div style="color:#fff;font-size:16px;font-weight:800;">{{ ucfirst($activeSub->billing_cycle) }}</div>
            <div style="color:rgba(255,255,255,0.5);font-size:10px;font-weight:600;text-transform:uppercase;">Billing</div>
        </div>
    </div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:16px;margin-bottom:24px;">
    ...
    @php
        ...
        $limitLabel = $livestockLimit === -1 ? 'Unlimited' : ($livestockLimit > 0 ? "of {$livestockLimit}" : 'Subscribe to add');
    ...
    <div style="background:#fff;border-radius:14px;padding:20px;border:1px solid #e2e8f0;position:relative;overflow:hidden;">
        ...
        <div style="font-size:10px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">My Animals</div>
    ...
    <div style="background:#fff;border-radius:14px;padding:20px;border:1px solid #e2e8f0;">
        <div style="font-size:10px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">Vet Consults</div>
        <div style="font-size:34px;font-weight:900;color:#b45309;line-height:1;">{{ $pendingVetConsults }}</div>
        <div style="font-size:11px;color:#94a3b8;margin-top:4px;font-weight:600;">Pending response</div>
    </div>

    <div style="background:#fff;border-radius:14px;padding:20px;border:1px solid #e2e8f0;">
        <div style="font-size:10px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">Net Balance</div>
        ...
        <div style="font-size:11px;color:{{ $netBalance >= 0 ? '#94a3b8' : '#dc2626' }};margin-top:4px;font-weight:600;">
            {{ $netBalance >= 0 ? 'Farm income surplus' : 'Farm deficit' }}
        </div>
    </div>
</div>
...
<div style="background:#fff;border-radius:16px;border:1px solid #e2e8f0;padding:20px 24px;margin-bottom:24px;">
    <div style="font-size:15px;font-weight:800;color:#0f172a;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid #f1f5f9;">Quick Actions</div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:12px;">
        ...
        <a href="{{ route('farmer.livestock') }}"
           ...
           onmouseenter="this.style.borderColor='#1FA84A'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#0F6B3E;text-align:center;">My Livestock</span>
        </a>
        ...
        <a href="{{ route('farmer.poultry') }}"
           ...
           onmouseenter="this.style.borderColor='#F4A300'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#b45309;text-align:center;">Poultry & Eggs</span>
        </a>
        ...
        <a href="{{ route('farmer.vet') }}"
           ...
           onmouseenter="this.style.borderColor='#2D9CDB'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#2D9CDB;text-align:center;">Request Vet</span>
        </a>
        @else
        <a href="{{ route('subscription.plans') }}"
           style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px 8px;background:#f8fafc;border-radius:12px;text-decoration:none;border:1px solid #e2e8f0;position:relative;opacity:0.7;">
            ...
            <span style="font-size:12px;font-weight:700;color:#94a3b8;text-align:center;">Request Vet</span>
        ...
        <a href="{{ route('farmer.finance') }}"
           ...
           onmouseenter="this.style.borderColor='#7c3aed'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#7c3aed;text-align:center;">Finance</span>
        </a>
        ...
        <a href="{{ route('farmer.reports') }}"
           ...
           onmouseenter="this.style.borderColor='#F4A300'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#b45309;text-align:center;">Reports</span>
        </a>
        @else
        <a href="{{ route('subscription.plans') }}"
           style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px 8px;background:#f8fafc;border-radius:12px;text-decoration:none;border:1px solid #e2e8f0;position:relative;opacity:0.7;">
            ...
            <span style="font-size:12px;font-weight:700;color:#94a3b8;text-align:center;">Reports</span>
        ...
        <a href="{{ route('diagnostics.scan') }}"
           style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px 8px;background:linear-gradient(135deg,#f0fdf4,#e0f2fe);border-radius:12px;text-decoration:none;border:1px solid #bbf7d0;">
            ...
            <span style="font-size:12px;font-weight:700;color:#0F6B3E;text-align:center;">AI Scan</span>
        </a>
        ...
        <a href="{{ route('marketplace') }}"
           ...
           onmouseenter="this.style.borderColor='#2D9CDB'" onmouseleave="this.style.borderColor='transparent'">
            ...
            <span style="font-size:12px;font-weight:700;color:#2D9CDB;text-align:center;">Marketplace</span>
        </a>
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:18px 8px;background:linear-gradient(135deg,#fffbeb,#fef3c7);border-radius:12px;border:1px solid #fcd34d;position:relative;">
            ...
            <span style="font-size:12px;font-weight:700;color:#b45309;text-align:center;">AI Advisor</span>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px;">
    ...
    <div style="background:#fff;border-radius:16px;border:1px solid #e2e8f0;overflow:hidden;">
        <div style="padding:16px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
            <div style="font-size:15px;font-weight:800;color:#0f172a;">Recent Animals</div>
            <a href="{{ route('farmer.livestock') }}" style="font-size:12px;color:#0F6B3E;font-weight:700;text-decoration:none;">View all →</a>
        </div>
        <div style="padding:0 4px;">
            ...
            <div style="text-align:center;padding:32px 20px;">
                ...
                <p style="font-size:13px;color:#64748b;margin-bottom:10px;">No animals registered yet</p>
                <a href="{{ route('farmer.livestock') }}" style="font-size:13px;color:#0F6B3E;font-weight:700;text-decoration:none;">Add your first animal →</a>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div style="background:#fff;border-radius:16px;border:1px solid #e2e8f0;overflow:hidden;">
        <div style="padding:16px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
            <div style="font-size:15px;font-weight:800;color:#0f172a;">Recent Consultations</div>
            @if($activeSub && $activeSub->hasFeature('vet_service_requests'))
            <a href="{{ route('farmer.vet') }}" style="font-size:12px;color:#0F6B3E;font-weight:700;text-decoration:none;">View all →</a>
            @endif
        </div>
        <div style="padding:0 4px;">
            ...
            <div style="text-align:center;padding:32px 20px;">
                @if(!$activeSub || !$activeSub->hasFeature('vet_service_requests'))
                <div style="font-size:36px;margin-bottom:10px;">🔒</div>
                <p style="font-size:13px;color:#64748b;margin-bottom:10px;">Vet consultations require Pro plan</p>
                <a href="{{ route('subscription.plans') }}" style="font-size:13px;color:#2D9CDB;font-weight:700;text-decoration:none;">Upgrade to Pro →</a>
                @else
                <div style="font-size:36px;margin-bottom:10px;">🩺</div>
                <p style="font-size:13px;color:#64748b;margin-bottom:10px;">No consultations yet</p>
                <a href="{{ route('farmer.vet') }}" style="font-size:13px;color:#0F6B3E;font-weight:700;text-decoration:none;">Request a vet →</a>
                @endif
            </div>
            @endforelse
        </div>
    ...
    <div style="background:#fff;border-radius:16px;border:1px solid #e2e8f0;overflow:hidden;">
        <div style="padding:16px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
            <div style="font-size:15px;font-weight:800;color:#0f172a;">Recent AI Diagnoses</div>
            <a href="{{ route('diagnostics.scan') }}" style="font-size:12px;color:#0F6B3E;font-weight:700;text-decoration:none;">New scan →</a>
        </div>
        <div style="padding:0 4px;">
            ...
            <div style="text-align:center;padding:32px 20px;">
                <div style="font-size:36px;margin-bottom:10px;">🔬</div>
                <p style="font-size:13px;color:#64748b;margin-bottom:10px;">No scans yet</p>
                <a href="{{ route('diagnostics.scan') }}" style="font-size:13px;color:#0F6B3E;font-weight:700;text-decoration:none;">Run your first scan →</a>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div style="background:#fff;border-radius:16px;border:1px solid #e2e8f0;overflow:hidden;">
        <div style="padding:16px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
            <div style="font-size:15px;font-weight:800;color:#0f172a;">Farm Finance</div>
            <a href="{{ route('farmer.finance') }}" style="font-size:12px;color:#0F6B3E;font-weight:700;text-decoration:none;">View all →</a>
        </div>
        <div style="padding:16px 20px;">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px;">
                <div style="background:#f0fdf4;border-radius:10px;padding:14px;">
                    <div style="font-size:10px;font-weight:700;color:#15803d;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:4px;">Total Income</div>
                ...
                <div style="background:#fef2f2;border-radius:10px;padding:14px;">
                    <div style="font-size:10px;font-weight:700;color:#dc2626;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:4px;">Total Expenses</div>
            ...
            @empty
            <p style="text-align:center;color:#94a3b8;font-size:12px;padding:10px 0;">No financial records yet</p>
            @endforelse
        </div>
    </div>
</div>
