    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-[70px]'" class="sidebar flex flex-col transition-all duration-300 z-30 shadow-2xl flex-shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-3 sidebar-scroll">
            ...
            <a href="{{ route('diagnostics.scan') }}" class="nav-link {{ request()->routeIs('diagnostics.*') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen" class="font-semibold" style="color:#1FA84A;">AI Smart Scan</span>
            </a>
            ...
            <div x-show="sidebarOpen" class="nav-section">Management</div>
            <a href="{{ route('ceo.users') }}" class="nav-link {{ request()->routeIs('ceo.users') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen">Users & Staff</span>
            </a>
            ...
            {{-- Farmer --}}
            @if($role === 'farmer')
            <div x-show="sidebarOpen" class="nav-section">Farm Management</div>
            <a href="{{ route('farmer.livestock') }}" class="nav-link {{ request()->routeIs('farmer.livestock') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen">My Livestock</span>
            </a>
            <a href="{{ route('farmer.poultry') }}" class="nav-link {{ request()->routeIs('farmer.poultry') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen">My Poultry</span>
            </a>
            ...
            {{-- Vet --}}
            @if($role === 'vet')
            <div x-show="sidebarOpen" class="nav-section">Veterinary</div>
            ...
            <a href="#" class="nav-link">
                ...
                <span x-show="sidebarOpen">Vaccinations</span>
            </a>
            <a href="#" class="nav-link">
                ...
                <span x-show="sidebarOpen">Disease Alerts</span>
            </a>
            @endif

            {{-- Agronomist --}}
            @if($role === 'agronomist')
            <div x-show="sidebarOpen" class="nav-section">Agronomy</div>
            <a href="#" class="nav-link">
                ...
                <span x-show="sidebarOpen">Crop Requests</span>
            </a>
            <a href="#" class="nav-link">
                <span class="nav-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg></span>
                <span x-show="sidebarOpen">Soil Reports</span>
            </a>
            @endif

            {{-- Finance --}}
            @if($role === 'finance')
            <div x-show="sidebarOpen" class="nav-section">Finance</div>
            <a href="#" class="nav-link">
                <span class="nav-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span>
                <span x-show="sidebarOpen">Income & Expenses</span>
            </a>
            <a href="#" class="nav-link">
                ...
                <span x-show="sidebarOpen">Payroll</span>
            </a>
            <a href="#" class="nav-link">
                <span class="nav-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></span>
            ...
            {{-- HR --}}
            @if($role === 'hr')
            <div x-show="sidebarOpen" class="nav-section">Human Resources</div>
            <a href="#" class="nav-link">
                <span class="nav-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                <span x-show="sidebarOpen">Staff Records</span>
            </a>
            <a href="#" class="nav-link">
                ...
                <span x-show="sidebarOpen">Attendance & Leave</span>
            </a>
            @endif
            ...
            <!-- Common for all -->
            <div x-show="sidebarOpen" class="nav-section">General</div>
            <a href="{{ route('marketplace') }}" class="nav-link {{ request()->routeIs('marketplace') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen">Marketplace</span>
            </a>
        ...
        <div class="p-3 border-t flex-shrink-0" style="border-color:rgba(255,255,255,0.08);">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all" style="color:rgba(255,100,100,0.8);" onmouseover="this.style.background='rgba(239,68,68,0.1)'" onmouseout="this.style.background='transparent'">
                    ...
                    <span x-show="sidebarOpen" class="text-sm font-semibold">Sign Out</span>
                </button>
            </form>
        </div>
    </aside>
        ...
        <header class="top-header h-16 flex items-center justify-between px-5 gap-4 flex-shrink-0 z-20">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="notif-btn">
                    ...
                    <div x-show="open" @click.outside="open=false" x-cloak
                        ...
                        <div class="p-4 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold px-2 py-0.5 rounded-full" style="background:rgba(15,107,62,0.1);color:#0F6B3E;">3 new</span>
                        </div>
                        <div class="divide-y divide-slate-50">
                            <div class="flex gap-3 p-3 hover:bg-slate-50 transition cursor-pointer">
                                <div class="w-8 h-8 rounded-lg flex-shrink-0 flex items-center justify-center" style="background:rgba(31,168,74,0.1);">
                                    <svg width="14" height="14" fill="none" stroke="#1FA84A" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                </div>
                                <div><p class="text-xs font-semibold text-slate-700">System operational</p><p class="text-xs text-slate-400 mt-0.5">All services running normally</p></div>
                            </div>
                            <div class="flex gap-3 p-3 hover:bg-slate-50 transition cursor-pointer">
                                <div class="w-8 h-8 rounded-lg flex-shrink-0 flex items-center justify-center" style="background:rgba(244,163,0,0.1);">
                                    <svg width="14" height="14" fill="none" stroke="#F4A300" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                                </div>
                                <div><p class="text-xs font-semibold text-slate-700">New AI scan result</p><p class="text-xs text-slate-400 mt-0.5">Crop diagnosis completed</p></div>
                            </div>
                            <div class="flex gap-3 p-3 hover:bg-slate-50 transition cursor-pointer">
                                <div class="w-8 h-8 rounded-lg flex-shrink-0 flex items-center justify-center" style="background:rgba(45,156,219,0.1);">
                                    <svg width="14" height="14" fill="none" stroke="#2D9CDB" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                                </div>
                                <div><p class="text-xs font-semibold text-slate-700">New consultation request</p><p class="text-xs text-slate-400 mt-0.5">Farmer awaiting veterinary advice</p></div>
                            </div>
                        </div>
                        <div class="p-3 text-center border-t border-slate-100">
                            <a href="#" class="text-xs font-semibold" style="color:#0F6B3E;">View all notifications</a>
                        </div>
                    </div>
                </div>
