...
<div class="flex h-screen overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-[70px]'" class="sidebar flex flex-col transition-all duration-300 z-30 shadow-2xl flex-shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-3 sidebar-scroll">
            ...
            @if($role === 'ceo')
            <a href="{{ route('ceo.monitoring') }}" class="nav-link {{ request()->routeIs('ceo.monitoring*') ? 'active' : '' }}">
            ...
            <a href="{{ route('ceo.feedback') }}" class="nav-link {{ request()->routeIs('ceo.feedback*') ? 'active' : '' }}">
                <span class="nav-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg></span>
                <span x-show="sidebarOpen">User Feedback</span>
            </a>
