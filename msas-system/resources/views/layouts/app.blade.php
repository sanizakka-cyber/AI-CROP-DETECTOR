    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="top-header h-16 flex items-center justify-between px-5 gap-4 flex-shrink-0 z-20">
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- Notifications -->
                @php $notifCount = \App\Models\Notification::where('user_id', auth()->id())->where('is_read', false)->count();
                     $recentNotifs = \App\Models\Notification::where('user_id', auth()->id())->latest()->limit(5)->get(); @endphp
