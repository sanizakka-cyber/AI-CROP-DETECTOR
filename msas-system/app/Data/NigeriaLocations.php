...
class NigeriaLocations
{
    public static function states(): array
    {
        return [
            ...
            ['name' => 'Federal Capital Territory', 'lgas' => ['Abaji','Abuja Municipal Area Council','Bwari','Gwagwalada','Kuje','Kwali']],
            ...
            ['name' => 'Kebbi',   'lgas' => ['Aleiro','Arewa','Argungu','Augie','Bagudo','Birnin Kebbi','Bunza','Dandi','Fakai','Gwandu','Jega','Kalgo','Koko/Besse','Maiyama','Ngaski','Sakaba','Shanga','Suru','Wasagu/Danko','Yauri','Zuru']],
            ...
            ['name' => 'Ogun',    'lgas' => ['Abeokuta North','Abeokuta South','Ado-Odo/Ota','Egbado North','Egbado South','Ewekoro','Ifo','Ijebu East','Ijebu North','Ijebu North East','Ijebu Ode','Ikenne','Imeko Afon','Ipokia','Obafemi Owode','Odeda','Odogbolu','Ogun Waterside','Remo North','Sagamu']],
            ...
            ['name' => 'Osun',    'lgas' => ['Aiyedade','Aiyedire','Atakumosa East','Atakumosa West','Boluwaduro','Boripe','Ede North','Ede South','Egbedore','Ejigbo','Ife Central','Ife East','Ife North','Ife South','Ifedayo','Ifelodun','Ila','Ilesa East','Ilesa West','Irepodun','Irewole','Isokan','Iwo','Obokun','Odo Otin','Ola Oluwa','Olorunda','Oriade','Orolu','Osogbo']],
    ...
    {
        return [
            'Nigeria','Ghana','Niger','Cameroon','Chad','Benin','Togo',
            'Senegal','Mali','Burkina Faso','Ivory Coast','Guinea','Sierra Leone',
            'Liberia','Gambia','Guinea-Bissau','Cape Verde','Mauritania',
            ...
            'Mozambique','Malawi','Angola','Democratic Republic of Congo',
            'Republic of Congo','Gabon','Equatorial Guinea','Central African Republic',
            'Comoros','Madagascar','Mauritius','Seychelles','Lesotho','Eswatini',
